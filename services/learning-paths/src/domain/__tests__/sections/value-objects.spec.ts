...
describe('Section value objects', () => {
	describe('SectionId', () => {
		...
		it('does not equal a SectionId with a different value', () => {
			const id1 = new SectionId({ value: makeUuid('123e4567-e89b-42d3-a456-426614174000') });
			const id2 = new SectionId({ value: makeUuid('223e4567-e89b-42d3-a456-426614174000') });

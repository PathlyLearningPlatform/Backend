...
describe('Lesson value objects', () => {
	describe('LessonId', () => {
		...
		it('does not equal a LessonId with a different value', () => {
			const id1 = new LessonId({ value: makeUuid('123e4567-e89b-42d3-a456-426614174000') });
			const id2 = new LessonId({ value: makeUuid('223e4567-e89b-42d3-a456-426614174000') });
	...
	describe('ActivityRef', () => {
		it('creates an activity reference with activityId and order', () => {
			const activityId = ActivityId.create('12345678-1234-4234-a456-426614174001');

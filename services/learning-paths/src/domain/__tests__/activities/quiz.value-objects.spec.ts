...
describe('Quiz value objects', () => {
	describe('QuestionId', () => {
		...
		it('does not equal a QuestionId with a different value', () => {
			const id1 = new QuestionId({ value: makeUuid('123e4567-e89b-42d3-a456-426614174000') });
			const id2 = new QuestionId({ value: makeUuid('223e4567-e89b-42d3-a456-426614174000') });

...
describe('Activity value objects', () => {
	describe('ActivityId', () => {
		...
		it('does not equal an ActivityId with a different value', () => {
			const id1 = new ActivityId({ value: makeUuid('123e4567-e89b-42d3-a456-426614174000') });
			const id2 = new ActivityId({ value: makeUuid('223e4567-e89b-42d3-a456-426614174000') });
	...
	describe('ActivityDescription', () => {
		it('creates a description value object', () => {
			const desc = new ActivityDescription({ value: 'An activity description' });
